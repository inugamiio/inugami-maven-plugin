...
public class FilesUtils {
    ...
    private static ReadPartResult readPart(final ByteBuffer buffer, int oldCursor, int bufferSize,
    ...
    public static void copyTemplate(File baseTemplate, File server,
                                    Map<String, String> values) throws FilesUtilsException {
